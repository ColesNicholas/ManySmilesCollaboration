...
## Open data
```{r}
DF <- readRDS("data/processed/DF.l.full.rds")
```
...
# needed 5 countries to get convergence
# but it depends on the countries
# 3 very different countries and n = 335 worked just fine
```
