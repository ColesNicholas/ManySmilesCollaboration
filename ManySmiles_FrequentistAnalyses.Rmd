...
### Temp
Participants do indeed find the pen-in-mouth task more difficult.
Usually the happy pose task is more difficult.
But, in pen-in-mouth, the neutral task is more difficult.
This is problematic because difficulty <-> happiness. This confound could cause us to erroneously observe a pen-in-mouth effect.
When controlling for difficulty, we do not find a pen-in-mouth effect.
```{r}
DF.l.inc %>% 
  group_by(condition) %>% 
